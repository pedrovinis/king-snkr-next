...
function Companyservices({ services }: Props) {
  return (
        ...
        >
          <div className={styles.cardBody}>
            <div>
              ...
              <p className={styles.company}>{service.companyName}</p>
...
export default function ServicessGrid({ services }: Props) {
  const companies = services.reduce((allCompanies: any, service) => {
    allCompanies[service.companyName] = [...(allCompanies[service.companyName] || []), service];
    return allCompanies;
  }, {});
    ...
    <>
      {Object.keys(companies).map((companyName: string) => (
        <div key={companyName} className={styles.companyRow}>
          ...
          <Companyservices services={companies[companyName]} />
        </div>
      ))}
    </>
  );
